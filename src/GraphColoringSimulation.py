...
import csv
# import Baselines
from Baselines import RandomSystem, MostChangedSystem, MostChangedInIntervalSystem, LatestChangedSystem, OmniscientSystem
...
#                    nodesToChange = agent.chooseNodesByDistribution() #agent chooses the nodes to change TODO: later possibly inform system of this choice
        ...
        #save results to file
        with open("../resultsTest/test.csv", 'ab') as csvfile:
    ...
    #            filename= '../results/0730/test_focus_colored_'+graphName+"_iterations"+str(maxIterations)+"_queryLimit"+str(queryLimit)+"_actionLimit"+str(actionLimit)+"_agents"+str(numAgents)+".csv"
        ...
        for numAgents in ([3]):
            for actionLimit in ([3]):
                outputFile =   '../resultsTest/2311_distnaceAndCluster_agents_'+str(numAgents)+'actionLimit_'+str(actionLimit)+'primaryProg0.8_Focus.csv'
